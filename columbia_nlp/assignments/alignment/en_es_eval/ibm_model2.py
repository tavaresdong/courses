...
if __name__ == '__main__':
    try:
        ...
        ibm_model2 = IBM_Model2('ibm.tmodel')
        if not used_exist_model:
            print 'Train ibm-model2'
            ibm_model2.train_model('corpus.en', 'corpus.es', 5)
            print 'training done'
            # ibm_model2.save_model('ibm2.tmodel', 'ibm.qmodel')
            print 'saving done'
        else:
            # ibm_model2.load_model('ibm.tmodel', 'ibm.qmodel')
            print 'loading done'

        ibm_model2.do_alignment('dev.en', 'dev.es', 'ibm2.out')
        print 'parsing done'
