...
class TestFactorizer {
  public static void main(String[] args) {
    ...
    final week2.ex2.Factorizer factorizer = new VolatileCachingFactorizer();
...
// Like Goetz p. 18
class StatelessFactorizer implements week2.ex2.Factorizer {
  public long[] getFactors(long p) {
...
class UnsafeCountingFactorizer implements week2.ex2.Factorizer {
...
// Like Goetz p. 23
class CountingFactorizer implements week2.ex2.Factorizer {
...
class UnsafeCachingFactorizer implements week2.ex2.Factorizer {
...
class TooSynchronizedCachingFactorizer implements week2.ex2.Factorizer {
...
// Like Goetz p. 31.
class CachingFactorizer implements week2.ex2.Factorizer {
  private long lastNumber = 1;
  private long[] lastFactors = new long[] { 1 };
...
// Like Goetz p. 50.
class VolatileCachingFactorizer implements week2.ex2.Factorizer {
...
class OneValueCache {
  ...
  // ex2: these fields needs to be final so after
  // safe publication(constructor return) other threads will
  // see the up-to-date value of these fields.
  // If these fields are not final, then this guarantee does not hold
