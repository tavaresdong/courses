...
int main(int argc, char* argv[]) {
  ...
  // testing.
  // Answer: the array will contain 11 elements 100 elements and 1000 elements
  fillArray(array, 10);
  ...
  // Answer: because arrays are continuous elements allocated together
  fillArray(&value, 1);
  ...
  // C++ programming.
  // Answer: the memory will not be reclaimed
  free(heap_array);
